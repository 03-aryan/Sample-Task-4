...
const (
	ReportService_GenerateReport_FullMethodName = "/report_service.ReportService/GenerateReport"
	ReportService_HealthCheck_FullMethodName    = "/report_service.ReportService/HealthCheck"
)
...
type ReportServiceClient interface {
	// GenerateReport takes a user ID and returns a report ID or error
	GenerateReport(ctx context.Context, in *GenerateReportRequest, opts ...grpc.CallOption) (*GenerateReportResponse, error)
	// HealthCheck returns the current status of the service
