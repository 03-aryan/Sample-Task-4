...
// Request message for GenerateReport
...
// Response message for GenerateReport
...
// Request message for HealthCheck (empty)
...
const file_proto_report_proto_rawDesc = "" +
	"\n" +
	"\x12proto/report.proto\x12\x0ereport_service\"0\n" +
	...
	"\rReportService\x12_\n" +
	"\x0eGenerateReport\x12%.report_service.GenerateReportRequest\x1a&.report_service.GenerateReportResponse\x12V\n" +
	"\vHealthCheck\x12\".report_service.HealthCheckRequest\x1a#.report_service.HealthCheckResponseB\tZ\a./protob\x06proto3"
...
var file_proto_report_proto_goTypes = []any{
	(*GenerateReportRequest)(nil),  // 0: report_service.GenerateReportRequest
	(*GenerateReportResponse)(nil), // 1: report_service.GenerateReportResponse
	(*HealthCheckRequest)(nil),     // 2: report_service.HealthCheckRequest
	(*HealthCheckResponse)(nil),    // 3: report_service.HealthCheckResponse
}
var file_proto_report_proto_depIdxs = []int32{
	0, // 0: report_service.ReportService.GenerateReport:input_type -> report_service.GenerateReportRequest
	2, // 1: report_service.ReportService.HealthCheck:input_type -> report_service.HealthCheckRequest
	1, // 2: report_service.ReportService.GenerateReport:output_type -> report_service.GenerateReportResponse
	3, // 3: report_service.ReportService.HealthCheck:output_type -> report_service.HealthCheckResponse
